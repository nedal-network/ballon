<x-filament-panels::page class="fi-dashboard-page">
    ...
    <ul class="flex flex-col gap-4 list-disc">
        ...
        <li>
            Utasok esetében Új utas felvitele gombbal tudsz új utast felvinni és annak adatait megadni. A rendszer annyi utast enged hozzáadni, amennyi a kupon, vagy összevont esetben kuponok összlétszáma. A kötelezően megadatanó adatok pirossal látszódnak. Az opcionális utasadatokat javasolt megadni. Arra semmilyen értesítést nem küldünk a repülés előtt.
